...
namespace MyTunes_app.api.Controllers
{
    ...
    public class HomeController : ControllerBase
    {
        ...
        [HttpPost]
        [Route("details/{albumid}/rank/update")]
        ...
        public ActionResult<Album> Buy_Song(int albumid, int songid, [FromBody] int buyclick)
        {


            var ServiceResult = _homeService.Buy_Song(albumid, songid, Convert.ToBoolean(buyclick));
            if (ServiceResult.ResponseCode != ResponseCode.Success)
                return BadRequest(ServiceResult.Error);
        ...
        public ActionResult<Album> Buy_Album(int albumid, [FromBody] int buyclick)
        {



            var ServiceResult = _homeService.Buy_Album(albumid,Convert.ToBoolean(buyclick));
            if (ServiceResult.ResponseCode != ResponseCode.Success)
                return BadRequest(ServiceResult.Error);
